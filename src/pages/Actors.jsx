...
export default function Actors() {
  ...
  const onChange2 = (e) => {
    setUpdateActor({ ...updateActor, [e.target.name]: e.target.value });
  };

  const actorFunc = async (e) => {
    e.preventDefault();
    if (actor.name === '') {
      info_toaster("Please Enter actor's name");
    } else {
      setLoader(true);
  ...
  const updateActorFunc = async (e) => {
    e.preventDefault();
    if (updateActor.name === '') {
      info_toaster('Please enter your UpdateName');
    } else {
      setLoader(true);
      let res = await PutAPI(`actors/${updateActor.id}`, {
      ...
      <DefaultLayout>
                  ...
                  <div className="h-40">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        name="name"
                        id="name"
                        placeholder="Product actor Name"
        ...
        >
          ...
          <ModalContent>
            <form>
              <ModalHeader>
                <h1 className="text-center">Update Product actor</h1>
              </ModalHeader>
              <ModalCloseButton />
              {loader ? (
                <div className="h-[160px]">Loading</div>
